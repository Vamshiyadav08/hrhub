  ...
  return (
    ...
    <div className='document-container'>
        ...
        <form className='doc-form-container' onSubmit={handlesubmit}>
          <div>
            <input type="text" className="documents-input" name='title' onChange={handleInputChange} placeholder='Title'/>
            <input type="text" className="documents-input" name='description' onChange={handleInputChange} placeholder='Description'/>
            <input type="text" className="documents-input" name='identification' onChange={handleInputChange} placeholder='Identification'/> 
            <input type="file" className="documents-input" name='file' onChange={handleInputChange} placeholder='Identification'/> 
